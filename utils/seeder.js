...
const restaurants = [
  {
    ...
    description: "Authentic Bengali and Indian comfort food made fresh for local families.",
    phone: '9830000001',
    openingHours: {
      monday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
      tuesday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
      wednesday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
      thursday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
      friday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
      saturday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
      sunday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
    },
  ...
  },
  {
    ...
    description: "Burgers, crispy sides and chilled beverages for a quick meal.",
    phone: '9830000002',
    openingHours: {
      monday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
      tuesday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
  ...
  },
  {
    ...
    description: "Aromatic dum biryani, kebabs and classic Mughlai favourites.",
    phone: '9830000003',
    openingHours: {
      monday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
      tuesday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
  ...
  },
  {
    ...
    description: "Freshly baked pizzas and Italian favourites with generous toppings.",
    phone: '9830000004',
    openingHours: {
      monday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
      tuesday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
  ...
  },
  {
    ...
    description: "Steamed momos, Chinese snacks and quick bites made to order.",
    phone: '9830000005',
    openingHours: {
      monday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
      tuesday: { closed: false, opensAt: '10:00', closesAt: '22:00' },
